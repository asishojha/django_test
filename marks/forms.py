...
class StudentForm(forms.ModelForm):
	...
	def __init__(self, *args, **kwargs):
		...
		for field in self.fields:
			...
			self.fields['fl'].label = SUBJECT_CODE_DICT[str(int(self['sub1'].value()))].title() #'math' => 'fl'
			self.fields['sl'].label = SUBJECT_CODE_DICT[str(int(self['sub2'].value()))].title() #'english' => second field
