...
class Student(models.Model):
    ...
    subj = models.CharField(max_length=40,null=True,blank=True)
    sub1 = models.CharField(max_length=2)
    sub2 = models.CharField(max_length=2)
    sub3 = models.CharField(max_length=2)
    fl = models.CharField(max_length=2 , null=True, blank=True, validators=[validate_marks])
    sl = models.CharField(max_length=2, null=True, blank=True, validators=[validate_marks])
    math = models.CharField(max_length=2, null=True, blank=True, validators=[validate_marks])
    psc = models.CharField(max_length=2, null=True, blank=True, validators=[validate_marks])
    lsc = models.CharField(max_length=2, null=True, blank=True, validators=[validate_marks])
    hist = models.CharField(max_length=2, null=True, blank=True, validators=[validate_marks])
    geog = models.CharField(max_length=2, null=True, blank=True, validators=[validate_marks])
